   ...
   <header class="bg-dark py-5">
      <div class="container px-4 px-lg-5 my-5">
         <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">팀1 프로젝트</h1>
            <p class="lead fw-normal text-white-50 mb-0">영화 자료 검색 사이트</p>
         </div>
      </div>
   </header>
                    ...
                    <div class="col mb-5">                      
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center" ><a class="btn btn-outline-dark mt-auto" href="view.jsp?title=<%=show.getTitle()%>">상세보기</a></div>
                            </div>
                        </div>                  
                    </div>   
    <%
